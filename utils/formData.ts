export const US_STATES = [
    ...
    { name: "District of Columbia", abbreviation: "DC" }, { name: "American Samoa", abbreviation: "AS" },
    { name: "Guam", abbreviation: "GU" }, { name: "Northern Mariana Islands", abbreviation: "MP" },
    { name: "Puerto Rico", abbreviation: "PR" }, { name: "U.S. Virgin Islands", abbreviation: "VI" }
];
